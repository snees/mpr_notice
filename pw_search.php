...
<body>
    ...
    <table class="pw_table">
            <tr><td><button class="id_search" name="id_search"><a href="./search.php">아이디 찾기</a></button></td><td><input type="submit" class="pw_search page" name="pw_search" value="비밀번호 찾기"/></td></tr>
