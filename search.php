...
<body>
    ...
    <form method="POST" action="./search.php">
        <table class="id_table">
            <tr><td><input type="submit" class="id_search page" name="id_search" value="아이디 찾기"/></td><td><button class="pw_search" name="pw_search"><a href="./pw_search.php">비밀번호 찾기</a></button></td></tr>
